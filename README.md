...
**TwitterFy** is a basic twitter app to read and compose tweets the [Twitter API](https://apps.twitter.com/).
...
1. Load more when hitting bottom
2. 
...
<img src='https://i.imgur.com/hIhJTaQ.gif' title='Video Walkthrough' width='' alt='Video Walkthrough' />

GIF created with [LiceCap](http://www.cockos.com/licecap/).

## Notes

Tried to implement infinite scroll, couldn't get the URL link to work
...
1. Add functionality in profiletab to access more information
2. Add more menues in the tabbar
...
Working with the new APImanager needed some time to adjust and thinkering on how to implement new functionality
